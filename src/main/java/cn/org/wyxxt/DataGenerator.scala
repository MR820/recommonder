...
object DataGenerator{
  def main(args: Array[String]) {
    ...
    makelist(10000,"/Users/xingzhiwei/java/Recommonder") // 应用词表,
    makeappdown(10000,"/Users/xingzhiwei/java/Recommonder") // 用户历史下载,主题,是一个应用,游戏中心,是一个应用,应用中心,是一个应用
    makesample(10000,"/Users/xingzhiwei/java/Recommonder")  // 模拟正负例样本  = 浏览记录+lable
  }
  /**
  模拟app的商品词表
